...
where
	...
	Message: RpcMsg<InnerService> + NeedAuth,
...
where
	App: AuthableApp<UnauthorizedError, InternalError>,
	Message: ClientStreamingMsg<InnerService> + NeedAuth,
	Route: FnOnce(
			(App, App::Claims),
			Message,
...
where
	App: AuthableApp<UnauthorizedError, InternalError>,
	Message: ServerStreamingMsg<InnerService> + NeedAuth,
...
where
	App: AuthableApp<UnauthorizedError, InternalError>,
	Message: BidiStreamingMsg<InnerService> + NeedAuth,
	Route: FnOnce(
			(App, App::Claims),
			Message,
			UpdateStream<Service, Endpoint, Message::Update, InnerService>,
